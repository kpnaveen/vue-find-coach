<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{'invalid': !rate.isValid}">
      ...
      <p v-if="!rate.isValid">Please enter rate greater than zero</p>
    </div>
    <div class="form-control" :class="{'invalid': !areas.isValid}">
      ...
      <div>
        ...
        <label for="career">Careers Advisery</label>
      </div>
      <p v-if="!areas.isValid">Atleast one expertise must be selected</p>
    </div>
    <p v-if="!isFormValid">Please enter valid inputs and try again</p>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.isFormValid = true;
      this.$store.dispatch('coach/addCoach', formData);
